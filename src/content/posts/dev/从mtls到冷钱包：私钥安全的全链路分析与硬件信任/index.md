...
对于iOS来说，整个元器件被称为**Security Enclave**
...
[Hardware security best practices](https://source.android.com/docs/security/best-practices/hardware)
...
$$ r=R\_{x}\\mod n\\\\ => x\_{r}=r 或 x\_{r}=r+n $$
...
[What makes Samsung Blockchain Keystore Unique?](https://developer.samsung.com/blockchain/keystore/understanding-keystore/what-makes-keystore-unique.html?utm_source=chatgpt.com)
